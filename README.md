...
GrammarSketch is a lightweight 2D shape grammar framework for computational geometry and rule-based geometric derivation.  
It is designed for Rhino.Python workflows with deterministic, staged pattern generation.
...
├── recipes/ # deterministic grammar inputs (JSON)
